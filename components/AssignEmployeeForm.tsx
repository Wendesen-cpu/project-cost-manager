        ...
        <div className="flex flex-col gap-4 bg-gray-50 p-6 rounded-lg shadow-sm">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                <div className="md:col-span-1">
                    <label className="block text-sm font-medium text-gray-700 mb-1">{t('projects.members')}</label>
                    <select
                    ...
                    >
                        <option value="">{t('projects.search')}</option>
                        {employees.map(emp => (
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">{t('projects.dailyHrs')}</label>
                    <input
                        type="number"
                        step="0.5"
                        min="0"
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">{t('projects.endDate')} ({t('common.optional')})</label>
                    <input
                        type="date"
                        value={endDate}
            ...
            <div className="flex justify-end">
                ...
                >
                    {loading ? t('common.loading') : t('projects.addTeamMember')}
                </button>
            </div>
        </div>
    );
